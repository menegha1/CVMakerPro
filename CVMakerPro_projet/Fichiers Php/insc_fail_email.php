...
<body> <!-- c'est la meme page que inscription.php mais avec un message d'erreur sur le mail -->
...
<h5 style ="text-align: center"><u> Email :</u><br/><br/><label><input type = "email" name = "email" required/></label>
    <h6 style="color: red; text-align: center">L'email est déjà utilisé</h6><br/>
    <h5 style ="text-align: center"><u> Mot de passe :</u><br/><br/><label><input type = "password" name = "mdp" required/></label></h5>
<br/>
